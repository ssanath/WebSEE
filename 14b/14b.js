...
.then(client => {
    ...
    app.get("/fillData", function(req,res) {
        res.sendFile(__dirname + "/14b.html");
    })
    ...
    app.get("/", function(req,res) {
        const text = `
            ...
            <ul>
                ...
                <li><a href="/displayQuery">Display students placed at Infosys</a></li>
    ...
    app.get("/displayQuery", function(req,res) {
        ...
        .then(result => {
            var table = `<table border="1"><tr><th>Name</th><th>USN</th><th>Comapny</th></tr>`;

            result.forEach(student => {
                table += `<tr><td>${student.Name}</td><td>${student.USN}</td><td>${student.Company}</td></tr>`;
            })
